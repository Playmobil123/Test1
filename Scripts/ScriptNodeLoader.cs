...
public static class ScriptNodeLoader {
    ...
    public static void ParseScriptNodeTree(uint rootPointer, string contextLabel) {
        ...
        HypeGame.Data.BlockEntry block = FindBlockByVirtualAddress(rootPointer);
        if (block == null) {
    ...
    private static uint ParseNodeRecursive(HypeGame.Data.BlockEntry block, uint offset, int currentIndent, string contextLabel) {
    ...
    /// <returns>The HypeGame.Data.BlockEntry containing the address, or null if not found.</returns>
