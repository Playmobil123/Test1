...
public static class AIModelLoader {
    ...
    public static AIModelStruct ParseAIModelStruct(uint aiModelPointer) {
        ...
        BlockEntry block = FindBlockByVirtualAddress(aiModelPointer);
        if (block == null) {
    ...
    /// <summary>
    /// Finds the BlockEntry containing the specified virtual address.
    /// </summary>
    /// <param name="va">The virtual address to search for.</param>
    /// <returns>The BlockEntry if found, otherwise null.</returns>
